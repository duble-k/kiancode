...
const App = () => {
  ...
  return (
    <div className="flex">
      ...
      <FixedLeftNav scrollToRef={scrollToRef} aboutRef={aboutRef} resumeRef={resumeRef} businessRef={businessRef} contactRef={contactRef}/>
      ...
      <div className="flex-1 lg:ml-48"> {/* Adjust margin-left to match the width of FixedLeftNav */}
        <TopNavWithDrawer scrollToRef={scrollToRef} aboutRef={aboutRef} resumeRef={resumeRef} businessRef={businessRef} contactRef={contactRef}/>
