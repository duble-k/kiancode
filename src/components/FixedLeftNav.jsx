...
const FixedLeftNav = ({ scrollToRef, aboutRef, resumeRef, adventureRef, businessRef, contactRef }) => {
    return (
        <div className="hidden lg:flex lg:flex-col lg:w-48 lg:fixed lg:left-0 lg:top-0 lg:bottom-0 bg-cyan-500">
            ...
            <div className="flex flex-col justify-center flex-grow">
                <ul className="p-4 text-3xl text-white">
                    ...
                    <li className="rounded-lg cursor-pointer hover:bg-gray-300" onClick={() => scrollToRef(adventureRef)}>Latest Adventures</li>
